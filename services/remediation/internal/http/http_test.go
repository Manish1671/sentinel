...
func TestHealthAndReady(t *testing.T) {
	cfg := config.Config{Port: 8093, Environment: "test", LogLevel: "error"}
	s := New(cfg, slog.New(slog.NewTextHandler(os.Stdout, &slog.HandlerOptions{Level: slog.LevelError})), nil, pingOK{}, readyOK{}, nil, nil)
